...
Apri il browser su: `https://demo-builder-pro.preview.emergentagent.com`
...
```bash
# Test health check
curl https://demo-builder-pro.preview.emergentagent.com/api/

# Test statistiche
curl https://demo-builder-pro.preview.emergentagent.com/api/stats/dashboard
```
