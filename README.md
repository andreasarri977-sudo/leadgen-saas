...
Apri il browser su: `https://site-editor-mvp.preview.emergentagent.com`
...
```bash
# Test health check
curl https://site-editor-mvp.preview.emergentagent.com/api/

# Test statistiche
curl https://site-editor-mvp.preview.emergentagent.com/api/stats/dashboard
```
